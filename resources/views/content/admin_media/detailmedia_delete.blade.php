          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="container col-md-10">
                <div align="right">                
                    <a href="/detailmedia" style="width:150px; text-align:center;" type="Submit" class="btn form-control alert-info"> {{$title}} </a>
                </div>
                <br>
                            ...
                            <div id="deleteModal{{$data->id}}" class="modal fade" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="card-body">
                                    <form action="/detailmedia/undestroy/{{$data->id}}" method="get">
                                      @csrf
                                      <div class="row">
                                        <div class="col-md-12 pr-8">
                                          <div class="form-group">
                                            <label>Apakah anda yakin akan mengembalikan data Media {{$data->nama_media}}</label>
                                          </div>
                                        </div>
                                      </div>                  
                                      <br>
