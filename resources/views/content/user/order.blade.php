                ...
                <div class="row">
                  <div class="col-md-12 pr-8">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="jumlah" id="jumlah" placeholder="Jumlah Order" required autofocus>
                    </div>
                  </div>
                </div>                  
                <br>
      ...
      processResults: function (data) {
        return {
          results:  $.map(data, function (item) {
                return {
                    text: item.nama_media+" | Kemasan : "+item.kemasan+" | Satuan : "+item.satuan,
                    id: item.id
                }
            })
        };
